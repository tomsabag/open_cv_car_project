...
def draw_angle(frame, curve):
    roi = frame[100:165, 175:305].copy()

    cv2.circle(frame, (240, 100), 60, (0, 0, 255), 4)

    cv2.line(frame, (180, 98), (300, 98), (0, 0, 255), 4)  # horizontal
...
def draw_car(frame, height, base_point):
    ...
    frame[height - car_y:height - car_y + car_y, base_point - int(car_x / 2):base_point + car_x - int(car_x / 2)] = \
        car_image
    return frame
